...
function PaperComponent(props) {
 ...
 function DraggableDialog({open, onClose, village}) {
   const {nomi , viloyat, tuman, raisFIO, rasiTel, email,
  ...
  return (<Dialog
        ...
        <DialogContent>
          <DialogContentText>
            ...
            <div style={{marginTop:'20px'}}><b>Rais telefon raqami</b> : <a style={{textDecoration:'none'}} href={`tel:${rasiTel}`}>{rasiTel}</a> ;</div>
