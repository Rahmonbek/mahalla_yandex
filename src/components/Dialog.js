  ...
  return (
    ...
    >
      <div style={{ display: "flex", justifyContent: "flex-end" }}>
        <Button style={{ width: "10px" }} onClick={onClose} color="primary">
          <CloseOutlined />
        </Button>
      </div>
      <DialogTitle
      ...
      <DialogContent>
        <DialogContentText>
          ...
          <div style={{ marginTop: "20px" }}>
            <b>Rais familiya ismi</b> : {raisFIO};
          </div>
          <div style={{ marginTop: "20px" }}>
            <b>Rais telefon raqami</b> :{" "}
            <a style={{ textDecoration: "none" }} href={`tel:${rasiTel}`}>
              {rasiTel}
            </a>{" "}
            ;
          </div>
          <div style={{ marginTop: "20px" }}>
            <b>Mahalla noziri familiya ismi</b> : {uchasFIO} ;
          </div>
          <div style={{ marginTop: "20px" }}>
            <b>Mahalla noziri telefon raqami</b> :{" "}
            <a style={{ textDecoration: "none" }} href={`tel:${uchasTel}`}>
              {uchasTel}
            </a>{" "}
            ;
          </div>
          <div style={{ marginTop: "20px" }}>
            <b>Mahalla posboni familiya ismi </b> : {posbonFIO} ;
          </div>
          <div style={{ marginTop: "20px" }}>
            <b>Mahalla posboni telefon raqami</b> :{" "}
            <a style={{ textDecoration: "none" }} href={`tel:${posbonTel}`}>
              {posbonTel}
            </a>{" "}
            ;
          </div>
          ...
          <div style={{ marginTop: "20px" }}>
            <b>Rais o'rinbosari familiya ismi </b> : {raiszami1FIO} ;
          </div>
          <div style={{ marginTop: "20px" }}>
            <b>Rais o'rinbosari telefon raqami</b> :{" "}
            <a style={{ textDecoration: "none" }} href={`tel:${raiszami1Tel}`}>
              {raiszami1Tel}
            </a>{" "}
            ;
          </div>
          ...
          <div style={{ marginTop: "20px" }}>
            <b>Kotiba familiya ismi </b> : {kotibaFIO} ;
          </div>
          <div style={{ marginTop: "20px" }}>
            <b>Kotiba telefon raqami</b> :{" "}
            <a style={{ textDecoration: "none" }} href={`tel:${kotibaTel}`}>
              {kotibaTel}
            </a>{" "}
            ;
          </div>
          <div style={{ marginTop: "20px" }}>
            <b>Telefon</b> :{" "}
            <a style={{ textDecoration: "none" }} href={`tel:${tel}`}>
              {tel}
            </a>{" "}
            ;
          </div>
