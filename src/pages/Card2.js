                ...
                <Row>
                  <Col lg={6} md={12}>
                    <Form.Group className="mb-3" controlId="formBasicname">
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.nomi}
                        required
                        style={{
                          fontSize: "13px",
                    ...
                    <Form.Group className="mb-3" controlId="formBasicviloyat">
                      ...
                      <select
                        defaultValue={this.state.edit.viloyat}
                        required
                        id="formBasicviloyat"
                        className="selectVil"
                      >
                    ...
                    <Form.Group className="mb-3" controlId="formBasictuman">
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.tuman}
                        required
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                    ...
                    <Form.Group className="mb-3" controlId="formBasictel">
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.tel}
                        required
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                    ...
                    <Form.Group className="mb-3" controlId="formBasicRaisFIO">
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.raisFIO}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    <Form.Group className="mb-3" controlId="formBasicRasiTel">
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.rasiTel}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    >
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.raiszami1FIO}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    >
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.raiszami1Tel}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    >
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.raiszami2FIO}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    >
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.raiszami2Tel}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                  ...
                  <Col lg={6} md={12}>
                    ...
                    >
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.raiszami3FIO}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    >
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.raiszami3Tel}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    >
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.raiszami4FIO}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    >
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.raiszami4Tel}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    <Form.Group className="mb-3" controlId="formBasicUchasFIO">
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.uchasFIO}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    <Form.Group className="mb-3" controlId="formBasicUchasTel">
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.uchasTel}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    <Form.Group className="mb-3" controlId="formBasicPosbonFIO">
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.posbonFIO}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    <Form.Group className="mb-3" controlId="formBasicPosbonTel">
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.posbonTel}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    >
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.qariyalarFIO}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    >
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.qariyalarTel}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    <Form.Group className="mb-3" controlId="formBasickotibFIO">
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.kotibaFIO}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
                    ...
                    <Form.Group className="mb-3" controlId="formBasickotibTel">
                      ...
                      <Form.Control
                        defaultValue={this.state.edit.kotibaTel}
                        style={{
                          fontSize: "13px",
                          backgroundColor: "#c2ffff91",
                        }}
